...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_time_units_key), context.getString(R.string.pref_time_units_metrics)).equals(context.getString(R.string.pref_time_units_metrics));
    }
    ...
    static public void resetLocation(Context context) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
